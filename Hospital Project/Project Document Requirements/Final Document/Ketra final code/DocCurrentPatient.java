...
public class DocCurrentPatient extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         */
        Prescription newPrescription = new Prescription(x);
    ...
    public void updateDatabase() {
        ...
        try {
            ...
            stmt = connect.createStatement();
            String update = "UPDATE PATIENTS set currentDrugs='" +drugs+"', "
                + "Diagonsis ='" + currentDiag +"', docComments='" 
                + comments +"' where fullname='" +name+"'";            

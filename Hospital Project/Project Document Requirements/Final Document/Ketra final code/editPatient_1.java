/* This window open up when the user needs to edit a patient. It gets data
 * from the database and displays it on the screen. (363 lines)
 */
...
public class editPatient_1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        CurrentPatient editCurrentPatient = new CurrentPatient(y);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editPatient_1.class.getName()).
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new editPatient_1(1).setVisible(true);
            }
        });
    }
    ...
    public void searchDatabase(int i){
        ...
        String query = "select fullName, Diagonsis, lastVisit, doctorName, "
                + "roomNumber, nursesStation, Address, phoneNumber, ssNumber, "
        ...
        try {
            ...
            connect = DriverManager.getConnection("jdbc:"
                ...
                result = stmt.executeQuery(query);
                 ...
                 if (i == 1){
                     //loops through the database to the correct row
                     for(int j = 0; j<i; j++){
                         result.next(); 
                     }
    ...
    public void updateDatabase(int y) {
        ...
        String patient = jLabel1.getText();
        
        
        Connection connect = null;
        String query = "SELECT * from Patients";
        String update = "UPDATE PATIENTS set roomNumber='" +roomNumber+"', "
                + "Diagonsis ='" + currentDiag +"', doctorName='" + doctor +"',"
                + " insurance='" +insuranceCompany+"', ssNumber='" +ssNumber+"'"
                + ", nursesStation='" +nursesStation+"', Address='" +address+"'"
                + ", phoneNumber='" +phoneNumber+"' where fullname ='" +patient+
                "'";
        try {
            Class.forName("org.sqlite.JDBC");

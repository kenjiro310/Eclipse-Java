...
public class Test extends JFrame {
	...
	public Test() {
		...
		panel.add(lblLogIn);
                ...
                final JLabel status = new JLabel("Enter username and password.");
                status.setFont(new Font("Calibri", Font.PLAIN, 44));
                status.setBounds(200, 320, 121, 38);
                //panel.add(status);
                                    ...
                                    if (result.next()){
                                       ...
                                       if (x.startsWith("Nur")){
                                        ...
                                        int reply = JOptionPane.showConfirmDialog
                                                (null, "Username or Password is "
                                                + "incorrect. Would you like to "
                                                + "try again?", "Incorrect Login",

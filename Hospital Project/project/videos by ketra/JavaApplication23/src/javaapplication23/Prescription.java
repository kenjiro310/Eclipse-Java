...
public class Prescription extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DocCurrentPatient view = new DocCurrentPatient();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DocCurrentPatient editCurrentPatient = new DocCurrentPatient();
...
public void searchDatabase(){
    ...
    public void sendPrescription(){
        ...
        String patient = jLabel4.getText();
        ...
        String insert = "INSERT INTO PHARMACY(NAME, DOCTOR, DOSAGE, PATIENT, COMMENTS)"
                + "VALUES('" +name+"','" +doctor+"', '"+dosage+"', '"+patient+"', '"+comments+"' )";

...
public class editDrug extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new editDrug(s).setVisible(true);
            }
        });
    }
    ...
    public void searchDatabase(String s){
        ...
        String editDrug = s;
        System.out.println("Drug to edit is: " +editDrug);
        Connection connect = null;
        String query = "select drugName, drugTimeLimit, maxDosage, drugNotes, incompDrugs from Drug where drugName='" +editDrug+"'";
    ...
    public void updateDatabase(String s) {
        ...
        Connection connect = null;
        String update = "UPDATE DRUG set drugName='" +drugName+"', drugTimeLimit"
                + " ='" + drugLimit +"', drugNotes='" + notes +"', maxDosage='" 
                +drugDosage+"', incompDrugs='" +incompdrug+"' where drugName='"
                +drugName+"'";
        try {
            Class.forName("org.sqlite.JDBC");
                connect = DriverManager.getConnection("jdbc:sqlite:F:/hospital/data (1).db");                        

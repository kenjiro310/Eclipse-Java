...
public class fillPrescription extends javax.swing.JFrame {
    ...
    public void searchDatabase(){
        ...
        try {
            ...
            connect1 = DriverManager.getConnection("jdbc:"
            ...
            if (result1.next()){
                ...
                jTextField1.setText(result1.getString("patient"));
                jTextField2.setText(result1.getString("name"));
                jTextField3.setText(result1.getString("doctor"));
                int status = result1.getInt("status");
                if (status == 0){
                   jTextField4.setText("Pending"); 
                }else{
                    jTextField4.setText("Filled");
                }
            }
    ...
    public void fillNewPrescription(){
        ...
        String update = "UPDATE PHARMACY set status='" +status+"' where Patient='" +patient+"'";
